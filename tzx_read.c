...
tzx_read_rom_block(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
tzx_read_turbo_block(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
tzx_read_pure_tone(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
tzx_read_pulses_block(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
tzx_read_pure_data(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
tzx_read_raw_data(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
tzx_read_generalised_data(libspectrum_tape *tape,
               const libspectrum_byte **ptr,
               const libspectrum_byte *end);
static libspectrum_error
tzx_read_pause(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
tzx_read_group_start(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
tzx_read_jump(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
tzx_read_loop_start(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
tzx_read_select(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
tzx_read_stop(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
tzx_read_set_signal_level(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
tzx_read_comment(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
tzx_read_message(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
tzx_read_archive_info(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
tzx_read_hardware(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
tzx_read_custom(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
...
static libspectrum_error
tzx_read_data(const libspectrum_byte **ptr, const libspectrum_byte *end, size_t *length, int bytes, libspectrum_byte **data);
static libspectrum_error
tzx_read_string(const libspectrum_byte **ptr, const libspectrum_byte *end, char **dest);
...
libspectrum_error internal_tzx_read(libspectrum_tape *tape, const libspectrum_byte *buffer, const size_t length)
{
    ...
    if (memcmp(ptr, libspectrum_tzx_signature, signature_length)) {
        libspectrum_print_error(LIBSPECTRUM_ERROR_SIGNATURE, "libspectrum_tzx_create: wrong signature");
...
static libspectrum_error tzx_read_rom_block(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    ...
    /* Check there's enough left in the buffer for the pause and the
          data length */
    if (end - (*ptr) < 4) {
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "tzx_read_rom_block: not enough data in buffer");
        return LIBSPECTRUM_ERROR_CORRUPT;
    }
...
static libspectrum_error tzx_read_turbo_block(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    libspectrum_tape_block* block;
    size_t length; libspectrum_byte *data;
...
static libspectrum_error tzx_read_pure_tone(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    libspectrum_tape_block* block;

    // Check we've got enough bytes
    if (end - (*ptr) < 4) {
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "tzx_read_pure_tone: not enough data in buffer");
        return LIBSPECTRUM_ERROR_CORRUPT;
    }
...
static libspectrum_error tzx_read_pulses_block(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    libspectrum_tape_block* block;
...
static libspectrum_error tzx_read_pure_data(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    libspectrum_tape_block* block;
    size_t length; libspectrum_byte *data;
    libspectrum_byte bits_in_last_byte;
...
static libspectrum_error tzx_read_raw_data(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    libspectrum_tape_block* block;
    size_t length; libspectrum_byte *data;
    libspectrum_byte bits_in_last_byte;
    ...
    // Check there's enough left in the buffer for all the metadata
    if (end - (*ptr) < 8) {
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "tzx_read_raw_data: not enough data in buffer");
        return LIBSPECTRUM_ERROR_CORRUPT;
    }
               ...
               const libspectrum_byte *end)
{
    ...
    if (end - (*ptr) < 4) {
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "%s: not enough data in buffer", __func__);
        return LIBSPECTRUM_ERROR_CORRUPT;
    }
    ...
    // Sanity check
    if (length < 14) {
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "%s: length less than minimum", __func__);
        return LIBSPECTRUM_ERROR_CORRUPT;
    }
    ...
    if (end - (*ptr) < data_size) {
        ...
        libspectrum_tape_block_free(block);
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "%s: data extends beyond end of block", __func__);
        return LIBSPECTRUM_ERROR_CORRUPT;
    }
    ...
    *ptr += data_count;
    ...
    if (*ptr != blockend) {
        libspectrum_tape_block_free(block);
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "%s: sanity check failed", __func__);
        return LIBSPECTRUM_ERROR_CORRUPT;
    }
...
static libspectrum_error tzx_read_pause(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    libspectrum_tape_block *block;

    // Check the pause actually exists
    if (end - (*ptr) < 2) {
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "tzx_read_pause: not enough data in buffer");
        return LIBSPECTRUM_ERROR_CORRUPT;
    }
...
static libspectrum_error tzx_read_group_start(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    libspectrum_tape_block *block;
    char *name;
    libspectrum_error error;
...
static libspectrum_error tzx_read_jump(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    libspectrum_tape_block *block;
    int offset;
    ...
    if (end - (*ptr) < 2) {
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "tzx_read_jump: not enough data in buffer");
        return LIBSPECTRUM_ERROR_CORRUPT;
    }
...
static libspectrum_error tzx_read_loop_start(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    libspectrum_tape_block *block;
...
static libspectrum_error tzx_read_select(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    libspectrum_tape_block* block;
    libspectrum_error error;
...
static libspectrum_error tzx_read_stop(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    libspectrum_tape_block *block;

    // Check the length field exists
    if (end - (*ptr) < 4) {
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "tzx_read_stop: not enough data in buffer");
        return LIBSPECTRUM_ERROR_CORRUPT;
    }
...
static libspectrum_error tzx_read_set_signal_level(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    libspectrum_tape_block *block;

    // Check the length field exists and signal level is available
    if (end - (*ptr) < 5) {
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "tzx_read_set_signal_level: not enough data in buffer");
        return LIBSPECTRUM_ERROR_CORRUPT;
    }
...
static libspectrum_error tzx_read_comment(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    libspectrum_tape_block* block;
    char *text;
    libspectrum_error error;
    ...
    // Check the length byte exists
    if ((*ptr) == end) {
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "tzx_read_comment: not enough data in buffer");
        return LIBSPECTRUM_ERROR_CORRUPT;
    }
...
static libspectrum_error tzx_read_message(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    libspectrum_tape_block* block;
    char *text;
    libspectrum_error error;
    ...
    if (end - (*ptr) < 2) {
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "tzx_read_message: not enough data in buffer");
        return LIBSPECTRUM_ERROR_CORRUPT;
    }
...
static libspectrum_error tzx_read_archive_info(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    libspectrum_tape_block* block;
    libspectrum_error error;
...
static libspectrum_error tzx_read_hardware(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    libspectrum_tape_block* block;
    size_t i, count;
    ...
    if ((*ptr) == end) {
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "tzx_read_hardware: not enough data in buffer");
        return LIBSPECTRUM_ERROR_CORRUPT;
    }
...
static libspectrum_error tzx_read_custom(libspectrum_tape *tape, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    libspectrum_tape_block* block;
    char *description;
    ...
    if (end - (*ptr) < 20) {
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "tzx_read_custom: not enough data in buffer");
        return LIBSPECTRUM_ERROR_CORRUPT;
    }
...
static libspectrum_error tzx_read_concat(const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    size_t signature_length = strlen(libspectrum_tzx_signature);
    ...
    if (end - (*ptr) < (ptrdiff_t)signature_length + 2 - 1) {
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "tzx_read_concat: not enough data in buffer");
        return LIBSPECTRUM_ERROR_CORRUPT;
    }
...
static void tzx_read_empty_block(libspectrum_tape *tape, libspectrum_tape_type id)
{
    libspectrum_tape_block *block;
...
static libspectrum_error tzx_read_data(const libspectrum_byte **ptr, const libspectrum_byte *end, size_t *length, int bytes, libspectrum_byte **data)
{
    ...
    if ((end - (*ptr)) < (ptrdiff_t)(*length)) {
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "tzx_read_data: not enough data in buffer");
        return LIBSPECTRUM_ERROR_CORRUPT;
    }
...
static libspectrum_error tzx_read_string(const libspectrum_byte **ptr, const libspectrum_byte *end, char **dest)
{
    size_t length;
    libspectrum_error error;
    char *ptr2;
