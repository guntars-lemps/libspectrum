...
static libspectrum_error
rzx_read_snapshot(libspectrum_rzx *rzx, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
rzx_read_input(libspectrum_rzx *rzx, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
rzx_read_frames(input_block_t *block, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
rzx_read_sign_start(libspectrum_rzx *rzx, const libspectrum_byte **ptr, const libspectrum_byte *end);
static libspectrum_error
rzx_read_sign_end(libspectrum_rzx *rzx, const libspectrum_byte **ptr, const libspectrum_byte *end);

static void
rzx_write_header(libspectrum_buffer *buffer, int sign);
static void
rzx_write_creator(libspectrum_buffer *buffer, libspectrum_buffer *block_data, libspectrum_creator *creator);
static libspectrum_error
...
static void
rzx_write_input(input_block_t *block, libspectrum_buffer *buffer, libspectrum_buffer *block_data, int compress);
static libspectrum_error
...
static libspectrum_error
rzx_write_signed_end(libspectrum_buffer *buffer, libspectrum_buffer *block_data, libspectrum_rzx_dsa_key *key);
...
libspectrum_error libspectrum_rzx_store_frame(libspectrum_rzx *rzx, size_t instructions, size_t count, libspectrum_byte *in_bytes)
{
    input_block_t *input;
...
libspectrum_dword libspectrum_rzx_get_keyid(libspectrum_rzx *rzx)
{
    ...
    list = g_slist_find_custom(rzx->blocks,
...
static libspectrum_error rzx_read_snapshot(libspectrum_rzx *rzx, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    rzx_block_t *block;
    libspectrum_snap *snap;
    ...
    if (flags & 0x01) {
        /* TODO log error if this isn't the first block as that can't be easily
              covered by prompting the user for a snapshot file (but should be       unlikely to encounter in reality?) */
        (*ptr) += blocklength - 9;
        return LIBSPECTRUM_ERROR_NONE;
    }
...
static libspectrum_error rzx_read_sign_start(libspectrum_rzx *rzx, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    rzx_block_t *block;
...
static libspectrum_error rzx_read_sign_end(libspectrum_rzx *rzx, const libspectrum_byte **ptr, const libspectrum_byte *end)
{
    rzx_block_t *block;
    signature_block_t *signature;
    size_t length;
...
static void rzx_write_input(input_block_t *block, libspectrum_buffer *buffer, libspectrum_buffer *block_data, int compress)
{
    size_t i;
...
static libspectrum_error rzx_write_signed_end(libspectrum_buffer *buffer, libspectrum_buffer *block_data, libspectrum_rzx_dsa_key *key)
{
#ifdef HAVE_GCRYPT_H
    libspectrum_error error;
