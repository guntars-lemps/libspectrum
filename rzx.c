...
libspectrum_error
libspectrum_rzx_rollback_to( libspectrum_rzx *rzx, libspectrum_snap **snap,                 size_t which )
{
...
libspectrum_error
libspectrum_rzx_store_frame( libspectrum_rzx *rzx, size_t instructions,                 size_t count, libspectrum_byte *in_bytes )
{
    input_block_t *input;
...
libspectrum_error
libspectrum_rzx_start_playback( libspectrum_rzx *rzx, int which,                libspectrum_snap **snap )
{
...
libspectrum_error
libspectrum_rzx_get_signature( libspectrum_rzx *rzx,                   libspectrum_signature *signature )
{
    GSList *list;
    rzx_block_t *block;
...
libspectrum_error
libspectrum_rzx_read( libspectrum_rzx *rzx, const libspectrum_byte *buffer,              size_t length )
{
    libspectrum_error error;
...
static void
rzx_write_block_header( libspectrum_buffer *dest, libspectrum_buffer *src,                        libspectrum_byte type )
{
...
void
libspectrum_rzx_insert_snap( libspectrum_rzx *rzx, libspectrum_snap *snap,                 int where )
{
    rzx_block_t *block;
...
void
libspectrum_rzx_iterator_delete( libspectrum_rzx *rzx,                 libspectrum_rzx_iterator it )
{
    block_free( it->data );
