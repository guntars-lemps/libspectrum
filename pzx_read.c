...
static libspectrum_error
read_next_pulse( const libspectrum_byte **buffer, const libspectrum_byte *end,                 size_t *pulse_repeats, libspectrum_dword *length )
{
...
libspectrum_error
internal_pzx_read( libspectrum_tape *tape, const libspectrum_byte *buffer,                   size_t length )
{
    libspectrum_error error;
