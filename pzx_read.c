...
read_block(libspectrum_tape *tape, const libspectrum_byte **buffer, const libspectrum_byte *end, pzx_context *ctx);
...
static libspectrum_error
pzx_read_data(const libspectrum_byte **ptr, const libspectrum_byte *end, size_t length, libspectrum_byte **data);

static libspectrum_error
pzx_read_string(const libspectrum_byte **ptr, const libspectrum_byte *end, char **dest);
...
get_id_byte(char *info_tag) {
    struct info_t *info = (struct info_t*)bsearch(info_tag, info_ids, ARRAY_SIZE(info_ids),
                                  ...
                                  pzx_context *ctx)
{
    ...
    bits_in_last_byte = count % LIBSPECTRUM_BITS_IN_BYTE ?
...
static libspectrum_error read_next_pulse(const libspectrum_byte **buffer, const libspectrum_byte *end, size_t *pulse_repeats, libspectrum_dword *length)
{
...
static libspectrum_error read_block(libspectrum_tape *tape, const libspectrum_byte **buffer, const libspectrum_byte *end, pzx_context *ctx)
{
    char id[5];
...
static libspectrum_error pzx_read_data(const libspectrum_byte **ptr, const libspectrum_byte *end, size_t length, libspectrum_byte **data)
{
