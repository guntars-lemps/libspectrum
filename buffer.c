...
void
libspectrum_buffer_reallocate( libspectrum_buffer *buffer,                               const size_t new_size )
{
...
void
libspectrum_buffer_write_byte( libspectrum_buffer *buffer,                               const libspectrum_byte data )
{
    libspectrum_buffer_write( buffer, &data, sizeof( libspectrum_byte ) ) ;
}

void
libspectrum_buffer_write_word( libspectrum_buffer *buffer,                               const libspectrum_word data )
{
...
void
libspectrum_buffer_write_dword( libspectrum_buffer *buffer,                                const libspectrum_dword data )
{
...
void
libspectrum_buffer_write_buffer( libspectrum_buffer *dest,                                 const libspectrum_buffer *src )
{
...
void
libspectrum_buffer_write( libspectrum_buffer *buffer, const void* data,                          const size_t size )
{
...
void
libspectrum_buffer_set( libspectrum_buffer *buffer, libspectrum_byte value,                        const size_t size )
{
    reallocate_to_new_size( buffer, size );
