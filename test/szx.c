...
static libspectrum_byte test_31_expected[] = {
...
static libspectrum_byte test_32_expected[] = {
    0x02, 0x6f, 0x28, 0xfa, // Border, 128, +3, ULA
    0x00, 0x00, 0x00, 0x00 // Reserved
};

static libspectrum_byte test_33_expected[] = {
    0x01, 0x00, 0x00, 0x00, // Flags
    0x00, 0x03 // Joystick 1 = Kempston, Joystick 2 = Sinclair 1
};

static libspectrum_byte test_34_expected[] = {
    0x01, 0x00, 0x00, 0x00, // Flags
    0x02 // Cursor joystick
};

static libspectrum_byte test_35_expected[] = {
    0x01, 0x00 // Flags
};

static libspectrum_byte ay_registers_data[] = {
    0x73, 0x03, 0xb1, 0x00, 0xbb, 0x0c, 0x19, 0x0f,
    0x1e, 0x07, 0x11, 0x71, 0x6c, 0x0a, 0x2b, 0x41
};

static libspectrum_byte test_36_expected[] = {
    0x01, // Flags
    0x08, // Register port
...
static libspectrum_byte test_37_expected[] = {
    0x49, 0x9d
};

static libspectrum_byte test_38_expected[] = {
    0x01, 0x00, // Flags
    0xab, 0x8c, 0x82, 0xd8, // Ports
    0x18, 0x11 // Page count and current page
};

static libspectrum_byte test_39_expected[] = {
    0x01, 0x00, // Flags
    0x37, // Memory control
    0x55 // Page count
};

static libspectrum_byte test_40_expected[] = {
    0x02, // Kempston mouse
    0x00, 0x00, 0x00, // AMX mouse CTRLA registers
    0x00, 0x00, 0x00 // AMX mouse CTRLB registers
};

static libspectrum_byte empty_chunk_expected[] = { /* Empty */ };

static libspectrum_byte test_42_expected[] = {
    0x45 // DAC + 128
};

static libspectrum_byte test_43_expected[] = {
    0xc0, // DAC
    0x00, 0x00, 0x00 // Reserved
};

static libspectrum_byte empty_ram_page_expected[] = {
    0x01, 0x00, // Flags
    0x00, // Page number
...
static libspectrum_byte empty_ram_page_start[] = {
    0x00, 0x00, // Flags
    0x00 // Page number
...
static szx_chunk_t *find_szx_chunk(libspectrum_buffer *buffer, const char *search)
{
    libspectrum_byte *data;
    ...
    while (data_remaining > 0) {
        ...
        length = length_buffer[0] + (length_buffer[1] << 8) + (length_buffer[2] << 16) + (length_buffer[3] << 24);
...
static test_return_t szx_write_block_test_with_flags(const char *id,
...
static test_return_t szx_write_block_test(const char *id,
                                          libspectrum_machine machine,
                                          void (*setter)(libspectrum_snap*),
                                          libspectrum_byte *expected,
                                          size_t expected_length)
{
    return szx_write_block_test_with_flags(id, machine, 0, setter, expected, expected_length, expected_length);
}


static test_return_t szx_write_uncompressed_block_test(const char *id,
                                                       libspectrum_machine machine,
                                                       void (*setter)(libspectrum_snap*),
                                                       libspectrum_byte *expected,
                                                       size_t expected_length,
                                                       size_t total_length)
{
    return szx_write_block_test_with_flags(id,
                                           machine,
...
static void z80r_setter(libspectrum_snap *snap)
{
...
{
    return szx_write_block_test("Z80R",
                                LIBSPECTRUM_MACHINE_48,
                                z80r_setter,
                                test_31_expected,
                                ARRAY_SIZE(test_31_expected));
}


static void spcr_setter(libspectrum_snap *snap)
{
...
{
    return szx_write_block_test("SPCR",
                                LIBSPECTRUM_MACHINE_PLUS3,
                                spcr_setter,
                                test_32_expected,
                                ARRAY_SIZE(test_32_expected));
}


static void joy_setter(libspectrum_snap *snap)
{
    ...
    libspectrum_snap_set_joystick_inputs(snap, 1, LIBSPECTRUM_JOYSTICK_INPUT_JOYSTICK_2);
}


test_return_t test_33(void)
{
    return szx_write_block_test("JOY\0",
                                LIBSPECTRUM_MACHINE_48,
                                joy_setter,
                                test_33_expected,
                                ARRAY_SIZE(test_33_expected));
}


static void keyb_setter(libspectrum_snap *snap)
{
...
{
    return szx_write_block_test("KEYB",
                                LIBSPECTRUM_MACHINE_48,
                                keyb_setter,
                                test_34_expected,
                                ARRAY_SIZE(test_34_expected));
}


static void zxpr_setter(libspectrum_snap *snap)
{
...
{
    return szx_write_block_test("ZXPR",
                                LIBSPECTRUM_MACHINE_48,
                                zxpr_setter,
                                test_35_expected,
                                ARRAY_SIZE(test_35_expected));
}


static void ay_setter(libspectrum_snap *snap)
{
    size_t i;
...
{
    return szx_write_block_test("AY\0\0",
                                LIBSPECTRUM_MACHINE_48,
                                ay_setter,
                                test_36_expected,
                                ARRAY_SIZE(test_36_expected));
}


static void scld_setter(libspectrum_snap *snap)
{
...
{
    return szx_write_block_test("SCLD",
                                LIBSPECTRUM_MACHINE_TC2048,
                                scld_setter,
                                test_37_expected,
                                ARRAY_SIZE(test_37_expected));
}


static void zxat_setter(libspectrum_snap *snap)
{
...
{
    return szx_write_block_test("ZXAT",
                                LIBSPECTRUM_MACHINE_48,
                                zxat_setter,
                                test_38_expected,
                                ARRAY_SIZE(test_38_expected));
}


static void zxcf_setter(libspectrum_snap *snap)
{
...
{
    return szx_write_block_test("ZXCF",
                                LIBSPECTRUM_MACHINE_48,
                                zxcf_setter,
                                test_39_expected,
...
static void amxm_setter(libspectrum_snap *snap)
{
...
{
    return szx_write_block_test("AMXM",
                                LIBSPECTRUM_MACHINE_48,
                                amxm_setter,
                                test_40_expected,
                                ARRAY_SIZE(test_40_expected));
}


static void side_setter(libspectrum_snap *snap)
{
...
{
    return szx_write_block_test("SIDE",
                                LIBSPECTRUM_MACHINE_48,
                                side_setter,
                                empty_chunk_expected,
                                ARRAY_SIZE(empty_chunk_expected));
}


static void drum_setter(libspectrum_snap *snap)
{
...
{
    return szx_write_block_test("DRUM",
                                LIBSPECTRUM_MACHINE_48,
                                drum_setter,
                                test_42_expected,
                                ARRAY_SIZE(test_42_expected));
}


static void covx_setter(libspectrum_snap *snap)
{
...
{
    return szx_write_block_test("COVX",
                                LIBSPECTRUM_MACHINE_48,
                                covx_setter,
                                test_43_expected,
...
static void zmmc_setter(libspectrum_snap *snap)
{
...
{
    return szx_write_block_test("ZMMC",
                                LIBSPECTRUM_MACHINE_48,
                                zmmc_setter,
                                empty_chunk_expected,
                                ARRAY_SIZE(empty_chunk_expected));
...
static void ramp_setter(libspectrum_snap *snap)
{
...
{
    return szx_write_block_test("RAMP",
                                LIBSPECTRUM_MACHINE_48,
                                ramp_setter,
...
static void atrp_setter(libspectrum_snap *snap)
{
...
{
    return szx_write_block_test("ATRP",
                                LIBSPECTRUM_MACHINE_48,
                                atrp_setter,
                                empty_ram_page_expected,
                                ARRAY_SIZE(empty_ram_page_expected));
...
static void cfrp_setter(libspectrum_snap *snap)
{
    libspectrum_byte *ram;
...
{
    return szx_write_block_test("CFRP",
                                LIBSPECTRUM_MACHINE_48,
                                cfrp_setter,
                                empty_ram_page_expected,
                                ARRAY_SIZE(empty_ram_page_expected));
...
{
    return szx_write_uncompressed_block_test("RAMP",
                                             LIBSPECTRUM_MACHINE_48,
                                             ramp_setter,
                                             empty_ram_page_start,
                                             ARRAY_SIZE(empty_ram_page_start),
...
{
    return szx_write_uncompressed_block_test("ATRP",
                                             LIBSPECTRUM_MACHINE_48,
                                             atrp_setter,
                                             empty_ram_page_start,
                                             ARRAY_SIZE(empty_ram_page_start),
...
{
    return szx_write_uncompressed_block_test("CFRP",
                                             LIBSPECTRUM_MACHINE_48,
                                             cfrp_setter,
                                             empty_ram_page_start,
                                             ARRAY_SIZE(empty_ram_page_start),
...
static test_return_t szx_read_block_test_with_template(const char *id,
                                                       const char *template,
...
static test_return_t szx_read_block_test(const char *id, int (*check_fn)(libspectrum_snap*))
{
    return szx_read_block_test_with_template(id, STATIC_TEST_PATH("szx-chunks/%s.szx"), check_fn);
}


static test_return_t szx_read_block_from_compressed_snap_test(const char *id, int (*check_fn)(libspectrum_snap*))
{
    return szx_read_block_test_with_template(id, STATIC_TEST_PATH("szx-chunks/%s-uncompressed.szx.gz"), check_fn);
}


static int test_44_check(libspectrum_snap *snap)
{
    int failed = 0;

    if (libspectrum_snap_a(snap) != 0xc4) {
        failed = 1;
    }
    ...
    if (libspectrum_snap_f(snap) != 0x1f) {
        failed = 1;
    }
    if (libspectrum_snap_bc(snap) != 0x0306) {
        failed = 1;
    }
    if (libspectrum_snap_de(snap) != 0x06e4) {
        failed = 1;
    }
    if (libspectrum_snap_hl(snap) != 0x0154) {
        failed = 1;
    }

    if (libspectrum_snap_a_(snap) != 0x69) {
        failed = 1;
    }
    if (libspectrum_snap_f_(snap) != 0x07) {
        failed = 1;
    }
    if (libspectrum_snap_bc_(snap) != 0xe7dc) {
        failed = 1;
    }
    if (libspectrum_snap_de_(snap) != 0xc3d0) {
        failed = 1;
    }
    if (libspectrum_snap_hl_(snap) != 0xdccb) {
        failed = 1;
    }

    if (libspectrum_snap_ix(snap) != 0x8ba3) {
        failed = 1;
    }
    if (libspectrum_snap_iy(snap) != 0x1c13) {
        failed = 1;
    }
    if (libspectrum_snap_sp(snap) != 0xf86d) {
        failed = 1;
    }
    if (libspectrum_snap_pc(snap) != 0xc81e) {
        failed = 1;
    }

    if (libspectrum_snap_i(snap) != 0x19) {
        failed = 1;
    }
    if (libspectrum_snap_r(snap) != 0x84) {
        failed = 1;
    }
    ...
    if (libspectrum_snap_tstates(snap) != 40) {
        failed = 1;
    }
    ...
    if (libspectrum_snap_halted(snap) != 0) {
        failed = 1;
    }
    ...
    if (libspectrum_snap_memptr(snap) != 0xdc03) {
        failed = 1;
    }
...
static int test_45_check(libspectrum_snap *snap)
{
    int failed = 0;

    if (libspectrum_snap_out_ula(snap) != 0xfa) {
        failed = 1;
    }
    if (libspectrum_snap_out_128_memoryport(snap) != 0x6f) {
        failed = 1;
    }
...
static int test_46_check(libspectrum_snap *snap)
{
    int failed = 0;

    if (libspectrum_snap_joystick_active_count(snap) != 2) {
        failed = 1;
    }
    ...
    if (libspectrum_snap_joystick_list(snap, 1) != LIBSPECTRUM_JOYSTICK_SINCLAIR_1) {
        failed = 1;
    }
    if (libspectrum_snap_joystick_inputs(snap, 1) != LIBSPECTRUM_JOYSTICK_INPUT_JOYSTICK_2) {
        failed = 1;
    }
...
static int test_47_check(libspectrum_snap *snap)
{
    int failed = 0;
    ...
    if (libspectrum_snap_joystick_list(snap, 0) != LIBSPECTRUM_JOYSTICK_CURSOR) {
        failed = 1;
    }
    if (libspectrum_snap_joystick_inputs(snap, 0) != LIBSPECTRUM_JOYSTICK_INPUT_KEYBOARD) {
        failed = 1;
    }
...
static int test_48_check(libspectrum_snap *snap)
{
...
static int test_49_check(libspectrum_snap *snap)
{
    int failed = 0;
    size_t i;
    ...
    if (libspectrum_snap_out_ay_registerport(snap) != 0x08) {
        failed = 1;
    }

    for (i = 0; i < 16; i++) {
        if (libspectrum_snap_ay_registers(snap, i) != ay_registers_data[i]) {
            failed = 1;
        }
    }
...
static int test_50_check(libspectrum_snap *snap)
{
    int failed = 0;
...
static int test_51_check(libspectrum_snap *snap)
{
    int failed = 0;
    ...
    if (libspectrum_snap_zxatasp_port_a(snap) != 0xab) {
        failed = 1;
    }
    if (libspectrum_snap_zxatasp_port_b(snap) != 0x8c) {
        failed = 1;
    }
    if (libspectrum_snap_zxatasp_port_c(snap) != 0x82) {
        failed = 1;
    }
    if (libspectrum_snap_zxatasp_control(snap) != 0xd8) {
        failed = 1;
    }
    if (libspectrum_snap_zxatasp_pages(snap) != 0x18) {
        failed = 1;
    }
    if (libspectrum_snap_zxatasp_current_page(snap) != 0x11) {
        failed = 1;
    }
...
static int test_52_check(libspectrum_snap *snap)
{
    int failed = 0;
    ...
    if (libspectrum_snap_zxcf_pages(snap) != 0x55) {
        failed = 1;
    }
...
static int test_53_check(libspectrum_snap *snap)
{
...
static int test_54_check(libspectrum_snap *snap)
{
...
static int test_55_check(libspectrum_snap *snap)
{
    int failed = 0;
    ...
    if (libspectrum_snap_specdrum_dac(snap) != -0x3b) {
        failed = 1;
    }
...
static int test_56_check(libspectrum_snap *snap)
{
    int failed = 0;
    ...
    if (libspectrum_snap_covox_dac(snap) != 0xc0) {
        failed = 1;
    }
...
static int test_58_check(libspectrum_snap *snap)
{
...
static int empty_ram_page_check(libspectrum_snap *snap, libspectrum_byte* (*get_ram_page)(libspectrum_snap*, int))
{
    int failed = 0;
    size_t i;
...
static int ramp_check(libspectrum_snap *snap)
{
...
static int atrp_check(libspectrum_snap *snap)
{
...
static int cfrp_check(libspectrum_snap *snap)
{
