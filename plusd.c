...
static libspectrum_error
libspectrum_plusd_read_header(const libspectrum_byte *buffer, size_t buffer_length, libspectrum_snap *snap);
static libspectrum_error
libspectrum_plusd_read_data(const libspectrum_byte *buffer, libspectrum_snap *snap);
static libspectrum_byte
readbyte(libspectrum_snap *snap, libspectrum_word address);
static void
libspectrum_plusd_read_128_data(libspectrum_snap *snap, const libspectrum_byte *buffer);
...
static libspectrum_error identify_machine(size_t buffer_length, libspectrum_snap *snap)
{
    ...
    case PLUSD_HEADER_LENGTH + 1 + 0x20000:
        ...
        break;
    default:
        libspectrum_print_error(LIBSPECTRUM_ERROR_CORRUPT, "plusd identify_machine: unknown length");
...
static libspectrum_error libspectrum_plusd_read_header(const libspectrum_byte *buffer, size_t buffer_length, libspectrum_snap *snap)
{
    libspectrum_byte i;
...
static libspectrum_error libspectrum_plusd_read_data(const libspectrum_byte *buffer, libspectrum_snap *snap)
{
    ...
    default:
        libspectrum_print_error(LIBSPECTRUM_ERROR_LOGIC, "libspectrum_plusd_read_data: unknown machine");
...
static libspectrum_byte readbyte(libspectrum_snap *snap, libspectrum_word address)
{
    int page;
...
static void libspectrum_plusd_read_128_data(libspectrum_snap *snap, const libspectrum_byte *buffer)
{
    int i;
