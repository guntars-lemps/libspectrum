            ...
            int in_flags )
{
    ...
    libspectrum_error error = libspectrum_snap_write_buffer( new_buffer, out_flags, snap, type, creator,                                   in_flags );
...
libspectrum_error
libspectrum_split_to_48k_pages( libspectrum_snap *snap,                const libspectrum_byte* data )
{
