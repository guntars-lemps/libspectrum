...
read_header(const libspectrum_byte *buffer, libspectrum_snap *snap, const libspectrum_byte **data, int *version, int *compressed);
static libspectrum_error
get_machine_type(libspectrum_snap *snap, libspectrum_byte type, libspectrum_byte mgt_type, int version);
static libspectrum_error
get_machine_type_v2(libspectrum_snap *snap, libspectrum_byte type);
static libspectrum_error
get_machine_type_v3(libspectrum_snap *snap, libspectrum_byte type, libspectrum_byte mgt_type);
static libspectrum_error
...
static libspectrum_error
read_blocks(const libspectrum_byte *buffer, size_t buffer_length, libspectrum_snap *snap, int version, int compressed);
static libspectrum_error
read_slt(libspectrum_snap *snap, const libspectrum_byte **next_block, const libspectrum_byte *end);
static libspectrum_error
...
static void
write_base_header(libspectrum_buffer *buffer, int *flags, libspectrum_snap *snap);
static libspectrum_error
write_extended_header(libspectrum_buffer *buffer, int *flags, libspectrum_snap *snap);
static void
write_pages(libspectrum_buffer *buffer, libspectrum_snap *snap, int compress);
static void
write_page(libspectrum_buffer *buffer, int page_num, libspectrum_byte *page, int compress);
static void
write_slt(libspectrum_buffer *buffer, libspectrum_snap *snap);
static void
write_slt_entry(libspectrum_buffer *buffer, libspectrum_word type, libspectrum_word id, libspectrum_dword slt_length);

static void
compress_block(libspectrum_byte **dest, size_t *dest_length, const libspectrum_byte *src, size_t src_length);
static void
uncompress_block(libspectrum_byte **dest, size_t *dest_length, const libspectrum_byte *src, size_t src_length);
...
static libspectrum_error read_header(const libspectrum_byte *buffer, libspectrum_snap *snap, const libspectrum_byte **data, int *version, int *compressed)
{
    ...
    (int)extra_length
        ...
        if (*version >= 3) {
            ...
            quarter_tstates = libspectrum_timings_tstates_per_frame(
...
static libspectrum_error get_machine_type(libspectrum_snap *snap, libspectrum_byte type, libspectrum_byte mgt_type, int version)
{
    libspectrum_error error;
...
static libspectrum_error read_blocks(const libspectrum_byte *buffer, size_t buffer_length, libspectrum_snap *snap, int version, int compressed)
{
...
static libspectrum_error read_slt(libspectrum_snap *snap, const libspectrum_byte **next_block, const libspectrum_byte *end)
{
...
libspectrum_error libspectrum_z80_write2(libspectrum_buffer *buffer, int *out_flags, libspectrum_snap *snap, int in_flags)
{
    libspectrum_error error;
...
static libspectrum_error write_extended_header(libspectrum_buffer *buffer, int *flags, libspectrum_snap *snap)
{
    ...
    quarter_states = libspectrum_timings_tstates_per_frame(
            libspectrum_snap_machine(snap)
) / 4;
...
static void write_slt_entry(libspectrum_buffer *buffer, libspectrum_word type, libspectrum_word id, libspectrum_dword slt_length)
{
...
static void compress_block(libspectrum_byte **dest, size_t *dest_length, const libspectrum_byte *src, size_t src_length)
{
...
static void uncompress_block(libspectrum_byte **dest, size_t *dest_length, const libspectrum_byte *src, size_t src_length)
{
    const libspectrum_byte *in_ptr;
    libspectrum_byte *out_ptr;
