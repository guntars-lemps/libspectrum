...
read_chunk(libspectrum_snap *snap, const libspectrum_byte **buffer, const libspectrum_byte *end);
...
static libspectrum_error inflate_block(libspectrum_byte **uncompressed, size_t *uncompressed_length, const libspectrum_byte **compressed, size_t compressed_length)
{
