...
libspectrum_error
libspectrum_ide_insert_into_drive( libspectrum_ide_drive *drv,                                   const char *filename )
{
    FILE *f;
    size_t l;
...
libspectrum_error
libspectrum_ide_commit( libspectrum_ide_channel *chn,            libspectrum_ide_unit unit )
{
...
int
libspectrum_ide_dirty( libspectrum_ide_channel *chn,               libspectrum_ide_unit unit )
{
...
libspectrum_error
libspectrum_ide_eject_from_drive( libspectrum_ide_drive *drv,                                  GHashTable *cache )
{
...
libspectrum_error
libspectrum_ide_eject( libspectrum_ide_channel *chn,                       libspectrum_ide_unit unit )
{
...
int
libspectrum_ide_read_sector_from_hdf( libspectrum_ide_drive *drv,    GHashTable *cache, libspectrum_dword sector_number, libspectrum_byte *dest )
{
...
void
libspectrum_ide_write_sector_to_hdf( libspectrum_ide_drive *drv, GHashTable *cache,    libspectrum_dword sector_number, libspectrum_byte *src )
{
...
libspectrum_byte
libspectrum_ide_read( libspectrum_ide_channel *chn,              libspectrum_ide_register reg )
{
    libspectrum_ide_drive *drv = &chn->drive[ chn->selected ];
...
void
libspectrum_ide_write( libspectrum_ide_channel *chn,               libspectrum_ide_register reg, libspectrum_byte data )
{
    switch( reg ) {
