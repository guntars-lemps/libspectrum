...
write_rom(libspectrum_tape_block *block, libspectrum_buffer *buffer, libspectrum_id_t type);
static libspectrum_error
write_turbo(libspectrum_tape_block *block, libspectrum_buffer *buffer, libspectrum_id_t type);
static libspectrum_error
write_pure_data(libspectrum_tape_block *block, libspectrum_buffer *buffer, libspectrum_id_t type);

static libspectrum_error
write_tap_block(libspectrum_buffer *buffer, libspectrum_byte *data, size_t data_length, libspectrum_id_t type);
static libspectrum_error
skip_block(libspectrum_tape_block *block, const char *message);


libspectrum_error internal_tap_read(libspectrum_tape *tape, const libspectrum_byte *buffer, const size_t length, libspectrum_id_t type)
{
...
static libspectrum_error write_tap_block(libspectrum_buffer* buffer, libspectrum_byte *data, size_t data_length, libspectrum_id_t type)
{
    size_t buf_length;
    libspectrum_byte parity;
