...
typedef struct timings_frame_t {
    ...
    libspectrum_word left_border, horizontal_screen, right_border, horizontal_retrace;

    // Frame timings in lines
    libspectrum_word top_border, vertical_screen, bottom_border, vertical_retrace;
...
libspectrum_dword libspectrum_timings_processor_speed(libspectrum_machine machine)
{
...
libspectrum_word libspectrum_timings_tstates_per_line(libspectrum_machine machine)
{
    ...
    return f->left_border + f->horizontal_screen + f->right_border + f->horizontal_retrace;
}
...
libspectrum_word libspectrum_timings_lines_per_frame(libspectrum_machine machine)
{
    ...
    return f->top_border + f->vertical_screen + f->bottom_border + f->vertical_retrace;
}
