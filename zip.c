...
static libspectrum_error
read_directory_info( zip_directory_info *info, const libspectrum_byte *buffer,                     const libspectrum_byte *end )
{
...
static int
read_file_header( zip_file_header *file_info, const libspectrum_byte *buffer,                  const libspectrum_byte *end )
{
...
int
libspectrum_zip_locate( struct libspectrum_zip *z, const char *filename,                         int flags, zip_stat *info )
{
...
static libspectrum_error
decompress_stream( struct libspectrum_zip *z, libspectrum_byte **buffer,                   size_t *buffer_size )
{
    libspectrum_error error;
    ...
    error = libspectrum_zip_inflate( z->ptr, file_compressed_left, buffer,                                   buffer_size );
    if (error ) return error;
...
libspectrum_error
libspectrum_zip_read( struct libspectrum_zip *z, libspectrum_byte **buffer,                      size_t *size )
{
