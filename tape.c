...
libspectrum_error
libspectrum_tape_write( libspectrum_byte **buffer, size_t *length,            libspectrum_tape *tape, libspectrum_id_t type )
{
...
/* The main function: called with a tape object and returns the number of
      ...
      on the tape */
libspectrum_error
libspectrum_tape_get_next_edge( libspectrum_dword *tstates, int *flags,                            libspectrum_tape *tape )
{
...
static void
do_tail_pause( libspectrum_dword *tstates,               int *end_of_block, int *flags )
{
    *end_of_block = 1;
    if (*tstates == 0 ) {
...
libspectrum_error
libspectrum_tape_pure_data_next_bit( libspectrum_tape_pure_data_block *block,                             libspectrum_tape_pure_data_block_state *state )
{
    int next_bit;
...
void
libspectrum_tape_raw_data_next_bit( libspectrum_tape_raw_data_block *block,                                    libspectrum_tape_raw_data_block_state *state )
{
    int length = 0;
...
get_generalised_data_bit( libspectrum_tape_generalised_data_block *block,                      libspectrum_tape_generalised_data_block_state *state )
{
...
libspectrum_byte
get_generalised_data_symbol( libspectrum_tape_generalised_data_block *block,                      libspectrum_tape_generalised_data_block_state *state )
{
...
void
libspectrum_tape_append_block( libspectrum_tape *tape,                   libspectrum_tape_block *block )
{
    if (tape->blocks == NULL ) {
...
void
libspectrum_tape_remove_block( libspectrum_tape *tape,                   libspectrum_tape_iterator it )
{
...
libspectrum_error
libspectrum_tape_block_description( char *buffer, size_t length,                                libspectrum_tape_block *block )
{
    switch( block->type ) {
    case LIBSPECTRUM_TAPE_BLOCK_ROM:
...
*/
libspectrum_error
libspectrum_tape_guess_hardware( libspectrum_machine *machine,                 const libspectrum_tape *tape )
{
