...
static libspectrum_error
rom_next_bit(libspectrum_tape_rom_block *block, libspectrum_tape_rom_block_state *state);
...
static libspectrum_error
turbo_next_bit(libspectrum_tape_turbo_block *block, libspectrum_tape_turbo_block_state *state);
...
libspectrum_error libspectrum_tape_pure_data_next_bit(libspectrum_tape_pure_data_block *block, libspectrum_tape_pure_data_block_state *state)
{
    int next_bit;
...
void libspectrum_tape_raw_data_next_bit(libspectrum_tape_raw_data_block *block, libspectrum_tape_raw_data_block_state *state)
{
    int length = 0;
...
static libspectrum_byte get_generalised_data_bit(libspectrum_tape_generalised_data_block *block, libspectrum_tape_generalised_data_block_state *state)
{
...
libspectrum_byte get_generalised_data_symbol(libspectrum_tape_generalised_data_block *block, libspectrum_tape_generalised_data_block_state *state)
{
...
libspectrum_error libspectrum_tape_data_block_next_bit(libspectrum_tape_data_block *block, libspectrum_tape_data_block_state *state)
{
    int next_bit;
...
void libspectrum_tape_append_block(libspectrum_tape *tape, libspectrum_tape_block *block)
{
    ...
    /* If we previously didn't have a tape loaded (implied by     tape->current_block == NULL), set up so that we point to the
          start of the tape */
...
libspectrum_tape_iterator_init(libspectrum_tape_iterator *iterator, libspectrum_tape *tape)
{
