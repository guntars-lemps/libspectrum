...
get_signature(gcry_mpi_t *r, gcry_mpi_t *s, libspectrum_byte *data, size_t data_length, libspectrum_rzx_dsa_key *key);
static libspectrum_error
...
static libspectrum_error
serialise_mpis(libspectrum_byte **signature, size_t *signature_length, gcry_mpi_t r, gcry_mpi_t s);
...
static libspectrum_error get_signature(gcry_mpi_t *r, gcry_mpi_t *s, libspectrum_byte *data, size_t data_length, libspectrum_rzx_dsa_key *key)
{
...
static libspectrum_error serialise_mpis(libspectrum_byte **signature, size_t *signature_length, gcry_mpi_t r, gcry_mpi_t s)
{
    gcry_error_t error;
